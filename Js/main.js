...
function close(){
    ...
    $('.side-nav-menu').animate({left:-width},700)
...
function open(){
    $('.side-nav-menu').animate({left:0},700)
        ...
        for(let i=0;i<5;i++){
            $('.links li').eq(i).animate({top:0},(i+7)*100)
        }
}
close()
...
function showSearchInputs() {
    ...
    <div class="row py-4 animate__animated animate__slideInRight wow slideInRight ">
        <div class="col-md-6 ">
...
async function getIngredients(){
    ...
    let response=await api.json()
    displayIngredients(response.meals.slice(0,40))
    $(".inner-loading-screen").fadeOut(300)
...
function showContacts() {
    ...
    <div class="container w-75 text-center">
        <div class="row g-4 wow bounceInUp">
            <div class="col-md-6">
        ...
        <button id="submitBtn" disabled class="btn px-2 mt-3">Submit</button>
    </div>
</div> `
